    ...
    <header className="app-header">
      <Link to="/">
        <img
          ...
          src="/mister-email/src/assets/images/memaillogo.png"
        />
      </Link>
      ...
      >
        ...
        <nav className={`${visibleClass} header-apps`}>
          <NavLink className="home" title="Home" to="/">
            <img src="/mister-email/src/assets/images/home.png" alt="home" />
          </NavLink>
          <NavLink className="mail" title="Mail" to="/email/inbox">
            <img src="/mister-email/src/assets/images/mail.png" alt="mail" />
          </NavLink>
        </nav>
      </div>
